...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/behaviourinferenceolmoautomata

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/behaviourinferenceolmoautomata: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/behaviourinferenceolmoautomata ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/KFoldCrossValidation.o: KFoldCrossValidation.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/KFoldCrossValidation.o KFoldCrossValidation.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/behaviourinferenceolmoautomata
