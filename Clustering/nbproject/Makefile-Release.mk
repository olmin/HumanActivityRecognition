...
${OBJECTDIR}/BehaviourSequence.o: BehaviourSequence.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BehaviourSequence.o BehaviourSequence.cpp

${OBJECTDIR}/ClusterData.o: ClusterData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ClusterData.o ClusterData.cpp
...
${OBJECTDIR}/PAA.o: PAA.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PAA.o PAA.cpp

${OBJECTDIR}/SimpleSkeleton.o: SimpleSkeleton.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SimpleSkeleton.o SimpleSkeleton.cpp
